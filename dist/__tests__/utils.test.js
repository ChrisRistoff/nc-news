...
describe("convertTimestampToDate", () => {
    test("returns a new object", () => {
        ...
        const result = (0, utils_1.convertTimestampToDate)(input);
    ...
    test("converts a created_at property to a date", () => {
        ...
        const input = { created_at: timestamp };
        const result = (0, utils_1.convertTimestampToDate)(input);
        expect(typeof result.created_at === "object").toBe(true);
        expect(result.created_at).toEqual(new Date(timestamp));
    });
    test("does not mutate the input", () => {
        const timestamp = 1557572706232;
        const input = { created_at: timestamp };
        (0, utils_1.convertTimestampToDate)(input);
...
describe("createRef", () => {
    test("returns an empty object, when passed an empty array", () => {
        const input = [];
        const actual = (0, utils_1.createRef)(input);
        const expected = {};
    ...
    test("returns a reference object when passed an array with a single items", () => {
        ...
        let actual = (0, utils_1.createRef)(input, "title", "article_id");
        let expected = { title1: 1 };
        expect(actual).toEqual(expected);
        actual = (0, utils_1.createRef)(input, "name", "title");
    ...
    test("returns a reference object when passed an array with many items", () => {
        ...
        const actual = (0, utils_1.createRef)(input, "title", "article_id");
...
describe("formatComments", () => {
    test("returns an empty array, if passed an empty array", () => {
        const comments = [];
        expect((0, utils_1.formatComments)(comments, {})).toEqual([]);
        expect((0, utils_1.formatComments)(comments, {})).not.toBe(comments);
    });
    test("converts created_by key to author", () => {
        const comments = [{ created_by: "ant" }, { created_by: "bee" }];
        const formattedComments = (0, utils_1.formatComments)(comments, {});
    ...
    test("replaces belongs_to value with appropriate id when passed a reference object", () => {
        ...
        const formattedComments = (0, utils_1.formatComments)(comments, ref);
