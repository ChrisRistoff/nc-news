...
exports.protectedArticleRouter = exports.articleRouter = void 0;
...
exports.protectedArticleRouter = (0, express_1.Router)();
/**
 * @swagger
 * components:
 *   schemas:
 ...
 */
exports.articleRouter.get("/articles", articlesController_1.getAllArticles);
/**
 * @swagger
 ...
 */
exports.articleRouter.get("/articles/:article_id", articlesController_1.getArticleById);
/**
 * @swagger
 * /api/articles/{article_id}:
 *   patch:
 ...
 *         description: Article ID not found
 */
exports.articleRouter.patch("/articles/:article_id", articlesController_1.updateArticleById);
/**
 * @swagger
 * /api/articles:
 *   post:
 ...
 */
exports.protectedArticleRouter.post("/articles", authMiddleware_1.protect, articlesController_1.createArticle);
/**
 * @swagger
 * /api/articles/{article_id}:
 *   delete:
 ...
 *         description: Article ID not found
 */
exports.protectedArticleRouter.delete("/articles/:article_id", authMiddleware_1.protect, articlesController_1.deleteArticle);
/**
 * @swagger
 ...
 *         description: Article ID not found
 */
exports.protectedArticleRouter.patch("/articles/:article_id/edit", authMiddleware_1.protect, articlesController_1.editArticleBody);
